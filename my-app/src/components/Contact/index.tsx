  ...
  return (
    <main>
      ...
      <form
        ref={form}
        onSubmit={sendEmail}
        className="flex flex-col justify-center items-center xl:w-[40%] max-xl:w-[80%] mx-auto font-zain text-2xl text-gray-500"
      >
        <section className="flex max-xl:flex-col 2xl:w-full justify-between py-8">
