...
export default function AboutMe() {
  ...
  return (
    <main id='sobre' className="flex flex-col justify-center items-center w-full h-fit py-20">
      <article className="justify-items-center max-ss:h-[600px] md:h-[800px] xl:h-[600px] max-sm:h-[800px] bg-[#6E07F3]">
        <section className="justify-center items-center self-center content-center text-center text-white max-ss:w-[80%] md:w-[70%] lg:w-[50%] h-[70%] ss:w-[85%]">
